...
public class ExecuteQuery {
	...
	public static final String CONNECTION_STRING = "jdbc:sqlite:/Gayathri/learning/software/sqlite3-db/testjava.db"
			+ DB_NAME;
	...
	public static void main(String[] args) {
		...
		try {
			...
			statement.execute("UPDATE " + TABLE_CONTACTS + " SET " + COLUMN_PHONE + "=5566789" + " WHERE " + COLUMN_NAME
					+ "='Jane'");
